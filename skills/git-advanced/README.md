...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill git-advanced
```

3. The git-advanced skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
