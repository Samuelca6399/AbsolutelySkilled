...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill vim-neovim
```

3. The vim-neovim skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
