...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill terraform-iac
```

3. The terraform-iac skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
