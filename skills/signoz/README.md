...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill signoz
```

3. The signoz skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
