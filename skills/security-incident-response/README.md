...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill security-incident-response
```

3. The security-incident-response skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
