...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill event-driven-architecture
```

3. The event-driven-architecture skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
